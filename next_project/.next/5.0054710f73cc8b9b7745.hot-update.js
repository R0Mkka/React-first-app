...
function (_Component) {
  ...
  _createClass(HeadMenu, [{
    ...
    value: function render() {
      var menu__logo = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
      ...
      // if (this.props.home_link === true){
      //   return (
      //     <div className="menu__logo">
      //       <a className="menu__home-link" href="index.html"> DIGITAL HEROES CLUB <sup className="menu__beta-word">βeta</sup> </a>
      //     </div>
      //   );
      // } else {
      //   return (
...
//# sourceMappingURL=5.0054710f73cc8b9b7745.hot-update.js.map